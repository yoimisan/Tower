...
from blender_ops import (
    clear_scene, setup_render, create_mesh, setup_camera, setup_light, 
    no_physics_render, physics_render
)
...
def main():
    ...
    for i in range(settings.NUM_SCENES):
        clear_scene()
        ...
        blocks_data, ped_num = generate_blocks_data(config, heightmap, collisiondetector, settings.RED_OR_GREEN)
